...
void TestNum10()
{
	...
	String str4((uint32_t)0xFFFFFFFF, 10);
	assert(str4 == "4294967295", "String(uint32_t value, int radix = 10)");
...
void TestNum16()
{
	...
	String str4((uint32_t)0xFFFFFFFF, 16);
	assert(str4 == "ffffffff", "String(uint32_t value, int radix = 16)");
