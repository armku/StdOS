...
void Task::ShowStatus()
{
    ...
    {
        debug_printf("Task::%-12s  %2d [%8d] 平均 %5uus 最大 %5dus 周期 %lds %s\r\n", Name, ID, Times, Cost, CpuTime, Period / 1000000, this->Enable ? " " : "禁用");
    }
    ...
    {
        debug_printf("Task::%-12s  %2d [%8d] 平均 %5uus 最大 %5dus 周期 %ldus %s\r\n", Name, ID, Times, Cost, CpuTime, Period, this->Enable ? " " : "禁用");
    }
}
