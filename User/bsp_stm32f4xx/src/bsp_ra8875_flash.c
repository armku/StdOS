...
*/
	...
	*/
	...
	/* 片选口线置低选中  */
	#define w25_SetCS(0)		GPIOB->BSRRH = GPIO_Pin_12

	/* 片选口线置高不选中 */
	#define w25_SetCS(1)		GPIOB->BSRRL = GPIO_Pin_12
#else
	/*
	...
	*/
	...
	#define	RCC_W25		(RCC_AHB1Periph_GPIOI | RCC_AHB1Periph_GPIOF)
...
/* 片选口线置低选中  */
#define W25_CS_0()      W25_CS_GPIO->BSRRH = W25_CS_PIN
/* 片选口线置高不选中 */
#define W25_CS_1()     W25_CS_GPIO->BSRRL = W25_CS_PIN
...
*/
#define W25_PWM_0()     W25_PWM_GPIO->BSRRH = W25_PWM_PIN
#define W25_PWM_1()     W25_PWM_GPIO->BSRRL = W25_PWM_PIN
...
static void w25_ConfigGPIO(void)
{
	...
	/* 使能GPIO 时钟 */
	RCC_AHB1PeriphClockCmd(RCC_W25, ENABLE);
