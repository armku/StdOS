...
#define _UTIL_H
    ...
    void SetBufFloat(uint8_t buf[], uint16_t pos, float da, uint8_t type = 0); //设置浮点数 0:小端 1：大端
    float GetBufFloat(uint8_t buf[], uint16_t pos,uint8_t type=0);//设置浮点数 0:小端 1：大端
