...
#define __CRC_H__
    ...
    class Crc
    {
        public:
            ...
            static uint16_t CRC16RTU(byte *pszBuf, uint unLength);
            static uint16_t CRC16CCITT(byte *pszBuf, uint unLength);
            static uint16_t CRC16Default(byte *pszBuf, uint unLength);
